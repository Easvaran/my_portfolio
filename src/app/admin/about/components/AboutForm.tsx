        ...
        <div className="p-8 rounded-[40px] bg-card border border-white/10 shadow-2xl space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea 
              rows={6} 
              {...register('details')} 
              className="w-full px-6 py-4 rounded-2xl bg-white/5 border border-white/10 focus:border-primary outline-none text-white transition-all leading-relaxed" 
            />
          </div>
        </div>

        <AboutStats control={control} register={register} setValue={setValue} watch={watch} />
